...
mu_branches = ["BToMuMuPi_mass","BToMuMuPi_pt","BToMuMuPi_eta","BToMuMuPi_phi",
		...
		"BToMuMuPi_dilepton_mass","BToMuMuPi_dilepton_pt","Muon_mediumId[BToMuMuPi_trg_mu_idx]","ProbeTracks_ndof[BToMuMuPi_pi_idx]","BToMuMuPi_fit_mu_eta","BToMuMuPi_fit_mu_phi","Muon_dz[BToMuMuPi_trg_mu_idx]","Muon_vx[BToMuMuPi_sel_mu_idx]","Muon_vy[BToMuMuPi_sel_mu_idx]"
...
,"BToMuEPi_dilepton_mass","BToMuEPi_dilepton_pt","Muon_softId[BToMuEPi_trg_mu_idx]","ProbeTracks_ndof[BToMuEPi_pi_idx]","BToMuEPi_fit_e_eta","BToMuEPi_fit_e_phi","Electron_dzTrg[BToMuEPi_sel_ele_idx]","Electron_vx[BToMuEPi_sel_ele_idx]","Electron_vy[BToMuEPi_sel_ele_idx]"
...
mu_sel = "Muon_pt[BToMuMuPi_trg_mu_idx]>7   && fabs(Muon_eta[BToMuMuPi_trg_mu_idx])<1.5 &&  Muon_pt[BToMuMuPi_sel_mu_idx]>1.5 &&  fabs(Muon_eta[BToMuMuPi_sel_mu_idx])<2 &&  ProbeTracks_pt[BToMuMuPi_pi_idx]>0.7  &&  fabs(ProbeTracks_eta[BToMuMuPi_pi_idx])<2  &&  fabs(ProbeTracks_dz[BToMuMuPi_pi_idx])>0.005  &&  fabs(ProbeTracks_dxy[BToMuMuPi_pi_idx])>0.005  && fabs(ProbeTracks_dzS[BToMuMuPi_pi_idx])>1.5 && fabs(ProbeTracks_dxyS[BToMuMuPi_pi_idx])>3 &&  fabs(ProbeTracks_DCASig[BToMuMuPi_pi_idx])>5   &&  BToMuMuPi_sv_prob>0.001  &&  BToMuMuPi_hnl_cos2D>0.99 &&  BToMuMuPi_sv_lxy/BToMuMuPi_sv_lxye>20  &&  fabs(Muon_dxy[BToMuMuPi_sel_mu_idx])>0.001 &&  fabs(Muon_dz[BToMuMuPi_sel_mu_idx])>0.0015 &&  fabs(Muon_dxyS[BToMuMuPi_sel_mu_idx])>1.5 &&  fabs(Muon_dzS[BToMuMuPi_sel_mu_idx])>1 ";
...
#rta.append(root2array(inputFiles,"Events",branches= mu_branches,object_selection={mu_sig+trg_BPark_mu:["BToMuMuPi_mass","BToMuMuPi_pt","BToMuMuPi_eta","BToMuMuPi_phi",
        "Muon_pt[BToMuMuPi_trg_mu_idx]","Muon_eta[BToMuMuPi_trg_mu_idx]","Muon_phi[BToMuMuPi_trg_mu_idx]",   
       "BToMuMuPi_hnl_mass","BToMuMuPi_hnl_pt","BToMuMuPi_sv_lxy","BToMuMuPi_hnl_cos2D","BToMuMuPi_sv_lxy_sig","BToMuMuPi_dr_mu_pi",
       "BToMuMuPi_dr_trgmu_hnl","BToMuMuPi_sv_prob","BToMuMuPi_sv_chi2","BToMuMuPi_sv_x","BToMuMuPi_sv_xe","BToMuMuPi_sv_y","BToMuMuPi_sv_ye","BToMuMuPi_sv_z","BToMuMuPi_sv_ze",
       "Muon_pt[BToMuMuPi_sel_mu_idx]","Muon_eta[BToMuMuPi_sel_mu_idx]","Muon_phi[BToMuMuPi_sel_mu_idx]","Muon_dz[BToMuMuPi_sel_mu_idx]","Muon_dzS[BToMuMuPi_sel_mu_idx]",
	...
	"BToMuMuPi_dilepton_mass","BToMuMuPi_dilepton_pt","ProbeTracks_ndof[BToMuMuPi_pi_idx]","BToMuMuPi_fit_mu_eta","BToMuMuPi_fit_mu_phi","Muon_dz[BToMuMuPi_trg_mu_idx]","Muon_vx[BToMuMuPi_sel_mu_idx]","Muon_vy[BToMuMuPi_sel_mu_idx]"
#,"BToMuMuPi_hnl_cos2D_star"
]
}))
...
#rta.append(root2array(inputFiles,"Events",branches= ele_branches,object_selection={pf_sig+trg_BPark_ele:["BToMuEPi_mass","BToMuEPi_pt","BToMuEPi_eta","BToMuEPi_phi",
       "BToMuEPi_hnl_mass","BToMuEPi_hnl_pt","BToMuEPi_sv_lxy","BToMuEPi_hnl_cos2D","BToMuEPi_sv_lxy_sig","BToMuEPi_dr_ele_pi",
       "BToMuEPi_dr_trgmu_hnl","BToMuEPi_sv_prob","BToMuEPi_sv_chi2","BToMuEPi_sv_x","BToMuEPi_sv_xe","BToMuEPi_sv_y","BToMuEPi_sv_ye","BToMuEPi_sv_z","BToMuEPi_sv_ze",
       "Electron_pt[BToMuEPi_sel_ele_idx]","Electron_eta[BToMuEPi_sel_ele_idx]","Electron_phi[BToMuEPi_sel_ele_idx]","Electron_dz[BToMuEPi_sel_ele_idx]","Electron_dzErr[BToMuEPi_sel_ele_idx]",
       "Electron_dxy[BToMuEPi_sel_ele_idx]","Electron_dxyErr[BToMuEPi_sel_ele_idx]","Electron_pfmvaId[BToMuEPi_sel_ele_idx]","Electron_mvaId[BToMuEPi_sel_ele_idx]",
       "ProbeTracks_pt[BToMuEPi_pi_idx]","ProbeTracks_eta[BToMuEPi_pi_idx]","ProbeTracks_phi[BToMuEPi_pi_idx]","ProbeTracks_dz[BToMuEPi_pi_idx]","ProbeTracks_dzS[BToMuEPi_pi_idx]",
       "ProbeTracks_dxy[BToMuEPi_pi_idx]","ProbeTracks_dxyS[BToMuEPi_pi_idx]","ProbeTracks_DCASig[BToMuEPi_pi_idx]","BToMuEPi_fit_pi_phi","BToMuEPi_hnl_charge","Electron_charge[BToMuEPi_sel_ele_idx]","BToMuEPi_hnl_eta","BToMuEPi_hnl_phi","BToMuEPi_dilepton_mass","BToMuEPi_dilepton_pt","Muon_softId[BToMuEPi_trg_mu_idx]","ProbeTracks_ndof[BToMuEPi_pi_idx]","BToMuEPi_fit_e_eta","BToMuEPi_fit_e_phi","Electron_dzTrg[BToMuEPi_sel_ele_idx]","Electron_vx[BToMuEPi_sel_ele_idx]","Electron_vy[BToMuEPi_sel_ele_idx]"#,"BToMuEPi_hnl_cos2D_star"
	]
}))
...
#rta.append(root2array(inputFiles,"Events",branches= ele_branches,object_selection={lowpT_sig+trg_BPark_ele:["BToMuEPi_mass","BToMuEPi_pt","BToMuEPi_eta","BToMuEPi_phi",
       "BToMuEPi_hnl_mass","BToMuEPi_hnl_pt","BToMuEPi_sv_lxy","BToMuEPi_hnl_cos2D","BToMuEPi_sv_lxy_sig","BToMuEPi_dr_ele_pi",
       "BToMuEPi_dr_trgmu_hnl","BToMuEPi_sv_prob","BToMuEPi_sv_chi2","BToMuEPi_sv_x","BToMuEPi_sv_xe","BToMuEPi_sv_y","BToMuEPi_sv_ye","BToMuEPi_sv_z","BToMuEPi_sv_ze",
       "Electron_pt[BToMuEPi_sel_ele_idx]","Electron_eta[BToMuEPi_sel_ele_idx]","Electron_phi[BToMuEPi_sel_ele_idx]","Electron_dz[BToMuEPi_sel_ele_idx]","Electron_dzErr[BToMuEPi_sel_ele_idx]",
       "Electron_dxy[BToMuEPi_sel_ele_idx]","Electron_dxyErr[BToMuEPi_sel_ele_idx]","Electron_pfmvaId[BToMuEPi_sel_ele_idx]","Electron_mvaId[BToMuEPi_sel_ele_idx]",
...
#rta.append(root2array(inputFiles,"Events",branches= tt_branches,object_selection={tt_sig+trg_BPark_trk:["BToMuEPiHD_mass","BToMuEPiHD_pt","BToMuEPiHD_eta","BToMuEPiHD_phi",
#       "BToMuEPiHD_hnl_mass","BToMuEPiHD_hnl_pt","BToMuEPiHD_sv_lxy","BToMuEPiHD_hnl_cos2D","BToMuEPiHD_sv_lxy_sig","BToMuEPiHD_dr_mu_pi",
#       "BToMuEPiHD_dr_trgmu_hnl","BToMuEPiHD_sv_prob","BToMuEPiHD_sv_chi2","BToMuEPiHD_sv_x","BToMuEPiHD_sv_xe","BToMuEPiHD_sv_y","BToMuEPiHD_sv_ye","BToMuEPiHD_sv_z","BToMuEPiHD_sv_ze",
#       "ProbeTracks_pt[BToMuEPiHD_sel_e_idx]","ProbeTracks_eta[BToMuEPiHD_sel_e_idx]","ProbeTracks_phi[BToMuEPiHD_sel_e_idx]","ProbeTracks_dz[BToMuEPiHD_sel_e_idx]","ProbeTracks_dzS[BToMuEPiHD_sel_e_idx]",
#       "ProbeTracks_dxy[BToMuEPiHD_sel_e_idx]","ProbeTracks_dxyS[BToMuEPiHD_sel_e_idx]","ProbeTracks_DCASig[BToMuEPiHD_sel_e_idx]","ProbeTracks_ndof[BToMuEPiHD_sel_e_idx]",
#       "ProbeTracks_pt[BToMuEPiHD_pi_idx]","ProbeTracks_eta[BToMuEPiHD_pi_idx]","ProbeTracks_phi[BToMuEPiHD_pi_idx]","ProbeTracks_dz[BToMuEPiHD_pi_idx]","ProbeTracks_dzS[BToMuEPiHD_pi_idx]",
#       "ProbeTracks_dxy[BToMuEPiHD_pi_idx]","ProbeTracks_dxyS[BToMuEPiHD_pi_idx]","ProbeTracks_DCASig[BToMuEPiHD_pi_idx]","BToMuEPiHD_fit_pi_phi","BToMuEPiHD_hnl_charge","ProbeTracks_charge[BToMuEPiHD_sel_e_idx]","BToMuEPiHD_hnl_eta","BToMuEPiHD_hnl_phi","BToMuEPiHD_dilepton_mass","BToMuEPiHD_dilepton_pt","Muon_softId[BToMuEPiHD_trg_mu_idx]","ProbeTracks_ndof[BToMuEPiHD_pi_idx]","BToMuEPiHD_fit_pi_eta","BToMuEPiHD_fit_pi_pt","ProbeTracks_dzTrg[BToMuEPiHD_sel_e_idx]","BToMuEPiHD_Tomu","BToMuEPiHD_Toele"#,"BToMuEPiHD_hnl_cos2D_star"
#	]+genComponents_trk
#}))
...
#print("for event %d and displacement %d, signal category %d",k,j,SigIdx)
	...
	#fill the output tree	
        ...
        treeSel.dz_trgMu_lep=  rta[SigIdx][j][51][0]            
   ...
   #     treeSel.cosTheta_star = rta[SigIdx][j][48][0]                                      
	...
	#print(B_mass)
		...
		treeSel.dilepton_mass = rta[SigIdx][j][45][0]                                      
		treeSel.dilepton_pt = rta[SigIdx][j][46][0]    
		point  = np.array( [np.float(treeSel.hnl_cos2D),np.float(abs(treeSel.hnl_l_dz)),np.float(abs(treeSel.hnl_l_dxy)),np.float(max(abs(treeSel.hnl_l_dxyS),abs(treeSel.hnl_pi_dxyS))),np.float(treeSel.hnl_vtxProb),np.float(treeSel.dilepton_mass),np.float(treeSel.hnl_pi_pt),np.float(treeSel.hnl_l_mvaId)])
		...
		treeSel.dilepton_mass = rta[SigIdx][j][45][0]                                      
		treeSel.dilepton_pt = rta[SigIdx][j][46][0]    
		point  = np.array( [np.float(treeSel.hnl_l_mvaId),np.float(abs(treeSel.hnl_l_dxyS)),np.float(max(abs(treeSel.hnl_l_dxyS),abs(treeSel.hnl_pi_dxyS))),np.float(treeSel.hnl_vtxProb),np.float(treeSel.hnl_cos2D),np.float(min(treeSel.hnl_pi_pt,treeSel.hnl_l_pt))])
		likelihood = ROOT.BinnedLikelihood(SigIdx,int(sys.argv[3]),int(sys.argv[4]),point)
		treeSel.likelihood =  likelihood if not math.isnan(likelihood ) else -99   
		treeSel.toEle = -1                 
		treeSel.toMu =  -1 
		...
		B_pt[0] = treeSel.B_pt
                hnl_pi_pt[0] = treeSel.hnl_pi_pt
                minPt[0] = min(treeSel.hnl_pi_pt,treeSel.hnl_l_pt)
                vtxProb[0] = treeSel.hnl_vtxProb
                MaxDxyS[0] = max(abs(treeSel.hnl_pi_dxyS),abs(treeSel.hnl_l_dxyS))
                hnl_l_dxyS[0] = abs(treeSel.hnl_l_dxyS)
                hnl_pi_dxyS[0] = abs(treeSel.hnl_pi_dxyS)
                MaxDz[0] = max(abs(treeSel.hnl_pi_dz),abs(treeSel.hnl_l_dz))
                dilepton_mass[0] = treeSel.dilepton_mass
                hnl_cos2D[0] = treeSel.hnl_cos2D
                hnl_vtxChi2[0] = treeSel.hnl_vtxChi2
                hnl_l_mvaId[0] = treeSel.hnl_l_mvaId
		...
		likelihood = ROOT.BinnedLikelihood(SigIdx,int(sys.argv[3]),int(sys.argv[4]),point)
		treeSel.likelihood =  likelihood if not math.isnan(likelihood ) else -99   
		treeSel.toEle =-1# rta[SigIdx][j][52][0]                        
		treeSel.toMu = -1# rta[SigIdx][j][53][0]                       
        treeSel.fill()
	break
      else:
	continue
